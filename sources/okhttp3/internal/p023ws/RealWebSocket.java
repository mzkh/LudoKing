...
import okhttp3.internal.p023ws.WebSocketReader.FrameCallback;
...
public final class RealWebSocket implements WebSocket, FrameCallback {
    ...
    public RealWebSocket(Request request, WebSocketListener webSocketListener, Random random2, long j) {
        if ("GET".equals(request.method())) {
            ...
            this.key = ByteString.m3709of(bArr).base64();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:0x0058, code lost:
        if ((r5 instanceof okhttp3.internal.p023ws.RealWebSocket.Message) == false) goto L_0x0086;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:26:0x005a, code lost:
        r1 = ((okhttp3.internal.p023ws.RealWebSocket.Message) r5).data;
        r0 = okio.Okio.buffer(r0.newMessageSink(((okhttp3.internal.p023ws.RealWebSocket.Message) r5).formatOpcode, (long) r1.size()));
        r0.write(r1);
        r0.close();
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:37:0x0088, code lost:
        if ((r5 instanceof okhttp3.internal.p023ws.RealWebSocket.Close) == false) goto L_0x009f;
     */
    ...
    public boolean writeOneFrame() throws java.io.IOException {
        ...
        L_0x0008:
            ...
            boolean r6 = r5 instanceof okhttp3.internal.p023ws.RealWebSocket.Close     // Catch:{ all -> 0x00aa }
        ...
        L_0x0031:
            ...
            r8 = r5
            okhttp3.internal.ws.RealWebSocket$Close r8 = (okhttp3.internal.p023ws.RealWebSocket.Close) r8     // Catch:{ all -> 0x00aa }
        ...
        L_0x004f:
            ...
            goto L_0x009a
        L_0x0056:
            boolean r2 = r5 instanceof okhttp3.internal.p023ws.RealWebSocket.Message     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x0086
            r1 = r5
            okhttp3.internal.ws.RealWebSocket$Message r1 = (okhttp3.internal.p023ws.RealWebSocket.Message) r1     // Catch:{ all -> 0x00a5 }
            okio.ByteString r1 = r1.data     // Catch:{ all -> 0x00a5 }
            okhttp3.internal.ws.RealWebSocket$Message r5 = (okhttp3.internal.p023ws.RealWebSocket.Message) r5     // Catch:{ all -> 0x00a5 }
        ...
        L_0x0086:
            boolean r2 = r5 instanceof okhttp3.internal.p023ws.RealWebSocket.Close     // Catch:{ all -> 0x00a5 }
            if (r2 == 0) goto L_0x009f
            okhttp3.internal.ws.RealWebSocket$Close r5 = (okhttp3.internal.p023ws.RealWebSocket.Close) r5     // Catch:{ all -> 0x00a5 }
        ...
        L_0x00aa:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p023ws.RealWebSocket.writeOneFrame():boolean");
    }
    ...
    public void writePingFrame() {
        ...
        L_0x0053:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.p023ws.RealWebSocket.writePingFrame():void");
    }
