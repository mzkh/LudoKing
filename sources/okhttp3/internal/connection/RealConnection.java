...
import okhttp3.internal.p023ws.RealWebSocket.Streams;
...
public final class RealConnection extends Listener implements Connection {
            ...
            if (code != 200) {
                if (code == 407) {
                    ...
                    if (authenticate != null) {
                        if (String.CLOSE.equalsIgnoreCase(build.header("Connection"))) {
                            return authenticate;
                        }
    ...
    public Streams newWebSocketStreams(StreamAllocation streamAllocation) {
        ...
        C18831 r0 = new Streams(true, this.source, this.sink) {
