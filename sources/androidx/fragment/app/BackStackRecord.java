...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
    ...
    public void dump(String str, PrintWriter printWriter, boolean z) {
        ...
        if (!this.mOps.isEmpty()) {
            ...
            for (int i = 0; i < size; i++) {
                C0256Op op = (C0256Op) this.mOps.get(i);
                switch (op.mCmd) {
                    case 0:
                        str2 = "NULL";
                        break;
    ...
    public void bumpBackStackNesting(int i) {
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                C0256Op op = (C0256Op) this.mOps.get(i2);
    ...
    public boolean interactsWith(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            C0256Op op = (C0256Op) this.mOps.get(i4);
            ...
            if (!(i5 == 0 || i5 == i3)) {
                for (int i6 = i; i6 < i2; i6++) {
                    ...
                    for (int i7 = 0; i7 < size2; i7++) {
                        C0256Op op2 = (C0256Op) backStackRecord.mOps.get(i7);
    ...
    public void executePopOps(boolean z) {
        for (int size = this.mOps.size() - 1; size >= 0; size--) {
            C0256Op op = (C0256Op) this.mOps.get(size);
            Fragment fragment = op.mFragment;
            if (fragment != null) {
            ...
            if (i2 != 1) {
                if (i2 == 2) {
                    ...
                    for (int size = arrayList.size() - 1; size >= 0; size--) {
                        ...
                        if (fragment5.mContainerId == i3) {
                            if (fragment5 == fragment3) {
                                ...
                                C0256Op op2 = new C0256Op(3, fragment5);
                    ...
                    if (op.mFragment == fragment2) {
                        this.mOps.add(i, new C0256Op(9, op.mFragment));
                        i++;
                        fragment2 = null;
                    }
                } else if (i2 != 7) {
    ...
    public boolean isPostponed() {
        for (int i = 0; i < this.mOps.size(); i++) {
            if (isFragmentPostponed((C0256Op) this.mOps.get(i))) {
                return true;
            }
        }
        return false;
    ...
    private static boolean isFragmentPostponed(C0256Op op) {
        Fragment fragment = op.mFragment;
