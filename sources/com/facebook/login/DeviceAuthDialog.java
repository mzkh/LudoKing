...
public class DeviceAuthDialog extends DialogFragment {
    ...
    public View initializeContentView(boolean z) {
        ...
        this.progressBar = inflate.findViewById(C1509R.C1511id.progress_bar);
        ...
        this.instructions = (TextView) inflate.findViewById(C1509R.C1511id.com_facebook_device_auth_instructions);
        this.instructions.setText(Html.fromHtml(getString(C1509R.string.com_facebook_device_auth_instructions)));
        return inflate;
    }
    ...
    public int getLayoutResId(boolean z) {
        return z ? C1509R.layout.com_facebook_smart_device_dialog_fragment : C1509R.layout.com_facebook_device_auth_dialog_fragment;
    }
    ...
    /* access modifiers changed from: private */
    public void presentConfirmation(String str, PermissionsLists permissionsLists, String str2, String str3, Date date, Date date2) {
        String string = getResources().getString(C1509R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C1509R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C1509R.string.com_facebook_smart_login_confirmation_cancel);
        ...
        final PermissionsLists permissionsLists2 = permissionsLists;
        final String str5 = str2;
        final Date date3 = date;
        final Date date4 = date2;
        C15746 r5 = new DialogInterface.OnClickListener() {
    ...
    public void onSuccess(String str, Long l, Long l2) {
        ...
        AccessToken accessToken = new AccessToken(str, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, null, null, null, null, date2, null, date);
            ...
            public void onCompleted(GraphResponse graphResponse) {
                if (!DeviceAuthDialog.this.completed.get()) {
                    ...
                    try {
                        ...
                        PermissionsLists handlePermissionResponse = Utility.handlePermissionResponse(jSONObject);
    ...
    /* access modifiers changed from: private */
    public void completeLogin(String str, PermissionsLists permissionsLists, String str2, Date date, Date date2) {
