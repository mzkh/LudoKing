...
class LoginLogger {
    ...
    static Bundle newAuthorizationLoggingBundle(String str) {
        ...
        String str2 = "";
        bundle.putString(EVENT_PARAM_METHOD, str2);
        bundle.putString(EVENT_PARAM_LOGIN_RESULT, str2);
        bundle.putString(EVENT_PARAM_ERROR_MESSAGE, str2);
        bundle.putString(EVENT_PARAM_ERROR_CODE, str2);
        bundle.putString(EVENT_PARAM_EXTRAS, str2);
        return bundle;
    }
