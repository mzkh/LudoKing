...
public class DeviceRequestsHelper {
    ...
    public static boolean isAvailable() {
        ...
        return VERSION.SDK_INT >= 16 && appSettingsWithoutQuery != null && appSettingsWithoutQuery.getSmartLoginOptions().contains(SmartLoginOption.Enabled);
    }
    ...
    private static boolean startAdvertisementServiceImpl(final String str) {
        ...
        C15151 r4 = new RegistrationListener() {
