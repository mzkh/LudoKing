...
public class InAppPurchaseActivityLifecycleTracker {
    ...
    public static void logPurchase(Context context, ArrayList<String> arrayList, boolean z) {
        if (!arrayList.isEmpty()) {
            ...
            for (Entry entry : InAppPurchaseEventManager.getSkuDetails(context, arrayList2, inAppBillingObj, z).entrySet()) {
                AutomaticAnalyticsLogger.logPurchase((String) hashMap.get(entry.getKey()), (String) entry.getValue(), z);
            }
        }
    }
}
