...
public interface DynamicLoader {
    ...
    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, @Nullable NativeAdLayout nativeAdLayout, Orientation orientation, int i, AdOptionsView adOptionsView);
    ...
    NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, @Nullable AdViewProvider adViewProvider, int i, @Nullable Type type, NativeAdViewAttributes nativeAdViewAttributes, int i2);
