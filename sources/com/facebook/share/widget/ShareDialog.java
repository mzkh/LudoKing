...
public final class ShareDialog extends FacebookDialogBase<ShareContent, Result> implements Sharer {
    ...
    static /* synthetic */ class C17091 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.ShareDialog.C17091.<clinit>():void");
        }
    }
    ...
    private class CameraEffectHandler extends ModeHandler {
        ...
        /* synthetic */ CameraEffectHandler(ShareDialog shareDialog, C17091 r2) {
            this();
        }
    ...
    private class FeedHandler extends ModeHandler {
        ...
        /* synthetic */ FeedHandler(ShareDialog shareDialog, C17091 r2) {
            this();
        }
    ...
    private class NativeHandler extends ModeHandler {
        ...
        /* synthetic */ NativeHandler(ShareDialog shareDialog, C17091 r2) {
            this();
        }
    ...
    private class ShareStoryHandler extends ModeHandler {
        ...
        /* synthetic */ ShareStoryHandler(ShareDialog shareDialog, C17091 r2) {
            this();
        }
    ...
    private class WebShareHandler extends ModeHandler {
        ...
        /* synthetic */ WebShareHandler(ShareDialog shareDialog, C17091 r2) {
            this();
        }
    ...
    public void logDialogShare(Context context, ShareContent shareContent, Mode mode) {
        ...
        int i = C17091.$SwitchMap$com$facebook$share$widget$ShareDialog$Mode[mode.ordinal()];
        String str = "unknown";
        ...
        internalAppEventsLogger.logEventImplicitly(str3, bundle);
    }
}
