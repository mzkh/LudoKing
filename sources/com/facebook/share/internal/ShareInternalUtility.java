...
public final class ShareInternalUtility {
    ...
    public static String getShareDialogPostId(Bundle bundle) {
        String str = ShareConstants.RESULT_POST_ID;
        if (bundle.containsKey(str)) {
            return bundle.getString(str);
        }
        String str2 = ShareConstants.EXTRA_RESULT_POST_ID;
    ...
    public static GraphRequest newUploadStagingResourceWithImageRequest(AccessToken accessToken, Bitmap bitmap, GraphRequest.Callback callback) {
        ...
        GraphRequest graphRequest = new GraphRequest(accessToken2, MY_STAGING_RESOURCES, bundle, HttpMethod.POST, callback);
        return graphRequest;
    }
