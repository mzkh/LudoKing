...
public class VideoUploader {
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        public void executeGraphRequestSynchronously(Bundle bundle) {
            ...
            GraphRequest graphRequest = new GraphRequest(this.uploadContext.accessToken, String.format(Locale.ROOT, "%s/videos", new Object[]{this.uploadContext.graphNode}), bundle2, HttpMethod.POST, null);
            GraphResponse executeAndWait = graphRequest.executeAndWait();
            String str = VideoUploader.ERROR_BAD_SERVER_RESPONSE;
            if (executeAndWait != null) {
                ...
                if (error != null) {
                    ...
                    try {
                        ...
                        endUploadWithFailure(new FacebookException(str, (Throwable) e));
                    }
                } else {
                    handleError(new FacebookException(str));
                }
            } else {
                handleError(new FacebookException(str));
            }
