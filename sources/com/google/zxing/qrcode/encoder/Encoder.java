...
public final class Encoder {
    ...
    static /* synthetic */ class C20221 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.google.zxing.qrcode.encoder.Encoder.C20221.<clinit>():void");
        }
    }
    ...
    static void appendBytes(String str, Mode mode, BitArray bitArray, String str2) throws WriterException {
        int i = C20221.$SwitchMap$com$google$zxing$qrcode$decoder$Mode[mode.ordinal()];
        if (i == 1) {
