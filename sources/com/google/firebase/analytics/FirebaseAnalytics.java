...
public final class FirebaseAnalytics {
    ...
    public final void logEvent(@Size(max = 40, min = 1) @NonNull String str, @Nullable Bundle bundle) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zza(TapjoyConstants.TJC_APP_PLACEMENT, str, bundle, true);
        }
    }
    ...
    public final void setUserProperty(@Size(max = 24, min = 1) @NonNull String str, @Size(max = 36) @Nullable String str2) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(TapjoyConstants.TJC_APP_PLACEMENT, str, (Object) str2, false);
        }
    }
    ...
    public final void setUserId(@Nullable String str) {
        if (this.zzl) {
            ...
            this.zzj.zzq().zzb(TapjoyConstants.TJC_APP_PLACEMENT, "_id", (Object) str, true);
        }
    }
