...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf82) {
        ...
        if (byteBuffer != null) {
            this.f3925bb = byteBuffer;
            this.f3925bb.clear();
            this.f3925bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f3925bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf82;
    }
    ...
    public FlatBufferBuilder init(ByteBuffer byteBuffer, ByteBufferFactory byteBufferFactory) {
        ...
        this.f3925bb.order(ByteOrder.LITTLE_ENDIAN);
        this.minalign = 1;
        this.space = this.f3925bb.capacity();
        this.vtable_in_use = 0;
        this.nested = false;
        this.finished = false;
        this.object_start = 0;
    ...
    public int offset() {
        return this.f3925bb.capacity() - this.space;
    }

    public void pad(int i) {
        for (int i2 = 0; i2 < i; i2++) {
            ByteBuffer byteBuffer = this.f3925bb;
            int i3 = this.space - 1;
            this.space = i3;
            byteBuffer.put(i3, 0);
        }
    ...
    public void prep(int i, int i2) {
        ...
        int capacity = ((((this.f3925bb.capacity() - this.space) + i2) ^ -1) + 1) & (i - 1);
        while (this.space < capacity + i + i2) {
            int capacity2 = this.f3925bb.capacity();
            ByteBuffer byteBuffer = this.f3925bb;
            this.f3925bb = growByteBuffer(byteBuffer, this.bb_factory);
            if (byteBuffer != this.f3925bb) {
                this.bb_factory.releaseByteBuffer(byteBuffer);
            }
            this.space += this.f3925bb.capacity() - capacity2;
        }
        pad(capacity);
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer order = this.f3925bb.slice().order(ByteOrder.LITTLE_ENDIAN);
        order.limit(i4);
        return order;
    }
    ...
    public <T extends Table> int createSortedVectorOfTables(T t, int[] iArr) {
        t.sortTables(iArr, this.f3925bb);
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.utf8.encodeUtf8(charSequence, this.f3925bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f3925bb;
        int i = this.space - remaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f3925bb.put(byteBuffer);
        return endVector();
    }
    ...
    public int endObject() {
        ...
        while (true) {
            ...
            int capacity = this.f3925bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f3925bb.getShort(capacity);
            if (s == this.f3925bb.getShort(i5)) {
                int i6 = 2;
                while (i6 < s) {
                    if (this.f3925bb.getShort(capacity + i6) == this.f3925bb.getShort(i5 + i6)) {
                        i6 += 2;
                    }
                }
                i = this.vtables[i4];
        ...
        if (i != 0) {
            this.space = this.f3925bb.capacity() - offset;
            this.f3925bb.putInt(this.space, i - offset);
        } else {
    ...
    public void required(int i, int i2) {
        int capacity = this.f3925bb.capacity() - i;
        if (!(this.f3925bb.getShort((capacity - this.f3925bb.getInt(capacity)) + i2) != 0)) {
    ...
    public void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f3925bb.capacity() - this.space);
        }
        this.f3925bb.position(this.space);
        this.finished = true;
    }
    ...
    public byte[] sizedByteArray(int i, int i2) {
        ...
        this.f3925bb.position(i);
        this.f3925bb.get(bArr);
        return bArr;
    }

    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f3925bb.capacity() - this.space);
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer duplicate = this.f3925bb.duplicate();
        duplicate.position(this.space);
        duplicate.limit(this.f3925bb.capacity());
