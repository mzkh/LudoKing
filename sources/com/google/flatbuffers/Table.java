...
public class Table {
    ...
    public int __offset(int i) {
        if (i < this.vtable_size) {
            return this.f3927bb.getShort(this.vtable_start + i);
        }
        return 0;
    }
    ...
    public int __indirect(int i) {
        return i + this.f3927bb.getInt(i);
    }
    ...
    public String __string(int i) {
        int i2 = i + this.f3927bb.getInt(i);
        return this.utf8.decodeUtf8(this.f3927bb, i2 + 4, this.f3927bb.getInt(i2));
    }

    /* access modifiers changed from: protected */
    public int __vector_len(int i) {
        int i2 = i + this.bb_pos;
        return this.f3927bb.getInt(i2 + this.f3927bb.getInt(i2));
    }

    /* access modifiers changed from: protected */
    public int __vector(int i) {
        int i2 = i + this.bb_pos;
        return i2 + this.f3927bb.getInt(i2) + 4;
    }
    ...
    public ByteBuffer __vector_as_bytebuffer(int i, int i2) {
        ...
        ByteBuffer order = this.f3927bb.duplicate().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public Table __union(Table table, int i) {
        int i2 = i + this.bb_pos;
        table.bb_pos = i2 + this.f3927bb.getInt(i2);
        table.f3927bb = this.f3927bb;
        int i3 = table.bb_pos;
        table.vtable_start = i3 - this.f3927bb.getInt(i3);
        table.vtable_size = this.f3927bb.getShort(table.vtable_start);
        return table;
    }
