...
public final class DataHolder extends AbstractSafeParcelable implements Closeable {
    ...
    @Field(getter = "getColumns", mo15151id = 1)
    private final String[] zalq;
    private Bundle zalr;
    @Field(getter = "getWindows", mo15151id = 2)
    private final CursorWindow[] zals;
    @Field(getter = "getStatusCode", mo15151id = 3)
    private final int zalt;
    @Field(getter = "getMetadata", mo15151id = 4)
    ...
    @Constructor
    DataHolder(@Param(mo15154id = 1000) int i, @Param(mo15154id = 1) String[] strArr, @Param(mo15154id = 2) CursorWindow[] cursorWindowArr, @Param(mo15154id = 3) int i2, @Param(mo15154id = 4) Bundle bundle) {
        this.mClosed = false;
        this.zalx = true;
        this.zalf = i;
        this.zalq = strArr;
