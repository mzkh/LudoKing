...
public final class WakeLockEvent extends StatsEvent {
    ...
    @Field(getter = "getTimeMillis", mo15151id = 2)
    private final long zzfo;
    @Field(getter = "getEventType", mo15151id = 11)
    private int zzfp;
    @Field(getter = "getWakeLockName", mo15151id = 4)
    private final String zzfq;
    @Field(getter = "getSecondaryWakeLockName", mo15151id = 10)
    private final String zzfr;
    @Field(getter = "getCodePackage", mo15151id = 17)
    private final String zzfs;
    @Field(getter = "getWakeLockType", mo15151id = 5)
    private final int zzft;
    @Field(getter = "getCallingPackages", mo15151id = 6)
    private final List<String> zzfu;
    @Field(getter = "getEventKey", mo15151id = 12)
    private final String zzfv;
    @Field(getter = "getElapsedRealtime", mo15151id = 8)
    private final long zzfw;
    @Field(getter = "getDeviceState", mo15151id = 14)
    private int zzfx;
    @Field(getter = "getHostPackage", mo15151id = 13)
    private final String zzfy;
    @Field(getter = "getBeginPowerPercentage", mo15151id = 15)
    private final float zzfz;
    @Field(getter = "getTimeout", mo15151id = 16)
    private final long zzga;
    @Field(getter = "getAcquiredWithTimeout", mo15151id = 18)
    private final boolean zzgb;

    @Constructor
    WakeLockEvent(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) long j, @Param(mo15154id = 11) int i2, @Param(mo15154id = 4) String str, @Param(mo15154id = 5) int i3, @Param(mo15154id = 6) List<String> list, @Param(mo15154id = 12) String str2, @Param(mo15154id = 8) long j2, @Param(mo15154id = 14) int i4, @Param(mo15154id = 10) String str3, @Param(mo15154id = 13) String str4, @Param(mo15154id = 15) float f, @Param(mo15154id = 16) long j3, @Param(mo15154id = 17) String str5, @Param(mo15154id = 18) boolean z) {
        this.versionCode = i;
        this.zzfo = j;
        this.zzfp = i2;
        this.zzfq = str;
