...
public final class zzk extends AbstractSafeParcelable {
    ...
    @Field(getter = "getAllowTestKeys", mo15151id = 3)
    private final boolean zzaa;
    @Field(defaultValue = "false", getter = "getForbidTestKeys", mo15151id = 4)
    private final boolean zzab;
    @Field(getter = "getCallingPackage", mo15151id = 1)
    private final String zzy;
    @Field(getter = "getCallingCertificateBinder", mo15151id = 2, type = "android.os.IBinder")
    @Nullable
    private final zze zzz;

    @Constructor
    zzk(@Param(mo15154id = 1) String str, @Param(mo15154id = 2) @Nullable IBinder iBinder, @Param(mo15154id = 3) boolean z, @Param(mo15154id = 4) boolean z2) {
        this.zzy = str;
