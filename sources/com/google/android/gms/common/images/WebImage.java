...
public final class WebImage extends AbstractSafeParcelable {
    ...
    @Field(getter = "getWidth", mo15151id = 3)
    private final int zane;
    @Field(getter = "getHeight", mo15151id = 4)
    private final int zanf;
    @Field(getter = "getUrl", mo15151id = 2)
    private final Uri zang;

    @Constructor
    WebImage(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) Uri uri, @Param(mo15154id = 3) int i2, @Param(mo15154id = 4) int i3) {
        this.zalf = i;
        this.zang = uri;
        this.zane = i2;
        this.zanf = i3;
