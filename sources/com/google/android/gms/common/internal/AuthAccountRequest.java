...
public class AuthAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(mo15151id = 6, type = "android.accounts.Account")
    private Account zax;

    @Constructor
    AuthAccountRequest(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) IBinder iBinder, @Param(mo15154id = 3) Scope[] scopeArr, @Param(mo15154id = 4) Integer num, @Param(mo15154id = 5) Integer num2, @Param(mo15154id = 6) Account account) {
        this.zalf = i;
        this.zanx = iBinder;
        this.zany = scopeArr;
        this.zanz = num;
