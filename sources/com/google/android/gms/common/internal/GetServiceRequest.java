...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @Constructor
    GetServiceRequest(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) int i2, @Param(mo15154id = 3) int i3, @Param(mo15154id = 4) String str, @Param(mo15154id = 5) IBinder iBinder, @Param(mo15154id = 6) Scope[] scopeArr, @Param(mo15154id = 7) Bundle bundle, @Param(mo15154id = 8) Account account, @Param(mo15154id = 10) Feature[] featureArr, @Param(mo15154id = 11) Feature[] featureArr2, @Param(mo15154id = 12) boolean z) {
        this.version = i;
        this.zzdg = i2;
        this.zzdh = i3;
