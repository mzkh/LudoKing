...
public class SignInButtonConfig extends AbstractSafeParcelable {
    ...
    @Field(getter = "getScopes", mo15151id = 4)
    @Deprecated
    private final Scope[] zany;
    @Field(getter = "getButtonSize", mo15151id = 2)
    private final int zapd;
    @Field(getter = "getColorScheme", mo15151id = 3)
    private final int zape;

    @Constructor
    SignInButtonConfig(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) int i2, @Param(mo15154id = 3) int i3, @Param(mo15154id = 4) Scope[] scopeArr) {
        this.zalf = i;
        this.zapd = i2;
        this.zape = i3;
        this.zany = scopeArr;
