...
public class ResolveAccountRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getSessionId", mo15151id = 3)
    private final int zapa;
    @Field(getter = "getSignInAccountHint", mo15151id = 4)
    private final GoogleSignInAccount zapb;
    @Field(getter = "getAccount", mo15151id = 2)
    private final Account zax;

    @Constructor
    ResolveAccountRequest(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) Account account, @Param(mo15154id = 3) int i2, @Param(mo15154id = 4) GoogleSignInAccount googleSignInAccount) {
        this.zalf = i;
        this.zax = account;
        this.zapa = i2;
