...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    @Field(getter = "getPendingIntent", mo15151id = 3)
    @Nullable
    private final PendingIntent zzi;
    @Field(getter = "getStatusMessage", mo15151id = 2)
    @Nullable
    private final String zzj;

    @Constructor
    @KeepForSdk
    Status(@Param(mo15154id = 1000) int i, @Param(mo15154id = 1) int i2, @Param(mo15154id = 2) @Nullable String str, @Param(mo15154id = 3) @Nullable PendingIntent pendingIntent) {
        this.zzg = i;
        this.zzh = i2;
        this.zzj = str;
