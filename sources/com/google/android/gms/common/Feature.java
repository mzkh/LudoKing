...
public class Feature extends AbstractSafeParcelable {
    ...
    @Field(getter = "getOldVersion", mo15151id = 2)
    @Deprecated
    private final int zzk;
    @Field(defaultValue = "-1", getter = "getVersion", mo15151id = 3)
    ...
    @Constructor
    public Feature(@Param(mo15154id = 1) String str, @Param(mo15154id = 2) int i, @Param(mo15154id = 3) long j) {
        this.name = str;
        this.zzk = i;
        this.zzl = j;
    }
