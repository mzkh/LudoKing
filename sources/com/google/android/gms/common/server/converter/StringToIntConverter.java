...
public final class StringToIntConverter extends AbstractSafeParcelable implements FieldConverter<String, Integer> {
    ...
    @Field(getter = "getSerializedMap", mo15151id = 2)
    ...
    public static final class zaa extends AbstractSafeParcelable {
        ...
        @Constructor
        zaa(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) String str, @Param(mo15154id = 3) int i2) {
            this.versionCode = i;
            this.zapp = str;
            this.zapq = i2;
        }
    ...
    @Constructor
    StringToIntConverter(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) ArrayList<zaa> arrayList) {
        this.zalf = i;
