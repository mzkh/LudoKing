...
public final class zzal extends AbstractSafeParcelable {
    ...
    @Field(defaultValue = "", getter = "getTag", mo15151id = 3)
    private final String tag;
    @Field(getter = "getGeofenceIds", mo15151id = 1)
    private final List<String> zzbu;
    @Field(getter = "getPendingIntent", mo15151id = 2)
    private final PendingIntent zzbv;

    @Constructor
    zzal(@Param(mo15154id = 1) @Nullable List<String> list, @Param(mo15154id = 2) @Nullable PendingIntent pendingIntent, @Param(mo15154id = 3) String str) {
