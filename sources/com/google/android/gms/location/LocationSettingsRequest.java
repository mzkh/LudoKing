...
public final class LocationSettingsRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getLocationRequests", mo15151id = 1)
    private final List<LocationRequest> zzbg;
    @Field(defaultValue = "false", getter = "alwaysShow", mo15151id = 2)
    private final boolean zzbh;
    @Field(getter = "needBle", mo15151id = 3)
    private final boolean zzbi;
    @Field(getter = "getConfiguration", mo15151id = 5)
    private zzae zzbj;
    ...
    @Constructor
    LocationSettingsRequest(@Param(mo15154id = 1) List<LocationRequest> list, @Param(mo15154id = 2) boolean z, @Param(mo15154id = 3) boolean z2, @Param(mo15154id = 5) zzae zzae) {
        this.zzbg = list;
        this.zzbh = z;
        this.zzbi = z2;
        this.zzbj = zzae;
