...
public final class LocationSettingsStates extends AbstractSafeParcelable {
    ...
    @Field(getter = "isGpsUsable", mo15151id = 1)
    private final boolean zzbn;
    @Field(getter = "isNetworkLocationUsable", mo15151id = 2)
    private final boolean zzbo;
    @Field(getter = "isBleUsable", mo15151id = 3)
    private final boolean zzbp;
    @Field(getter = "isGpsPresent", mo15151id = 4)
    private final boolean zzbq;
    @Field(getter = "isNetworkLocationPresent", mo15151id = 5)
    private final boolean zzbr;
    @Field(getter = "isBlePresent", mo15151id = 6)
    private final boolean zzbs;

    @Constructor
    public LocationSettingsStates(@Param(mo15154id = 1) boolean z, @Param(mo15154id = 2) boolean z2, @Param(mo15154id = 3) boolean z3, @Param(mo15154id = 4) boolean z4, @Param(mo15154id = 5) boolean z5, @Param(mo15154id = 6) boolean z6) {
        this.zzbn = z;
        this.zzbo = z2;
        this.zzbp = z3;
        this.zzbq = z4;
