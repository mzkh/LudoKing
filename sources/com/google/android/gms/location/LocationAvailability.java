...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Deprecated
    private int zzas;
    @Field(defaultValueUnchecked = "0", mo15151id = 3)
    private long zzat;
    @Field(defaultValueUnchecked = "LocationAvailability.STATUS_UNSUCCESSFUL", mo15151id = 4)
    private int zzau;
    @Field(mo15151id = 5)
    private zzaj[] zzav;

    @Constructor
    LocationAvailability(@Param(mo15154id = 4) int i, @Param(mo15154id = 1) int i2, @Param(mo15154id = 2) int i3, @Param(mo15154id = 3) long j, @Param(mo15154id = 5) zzaj[] zzajArr) {
        this.zzau = i;
        this.zzar = i2;
        this.zzas = i3;
        this.zzat = j;
