...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Constructor
    public ActivityRecognitionResult(@Param(mo15154id = 1) List<DetectedActivity> list, @Param(mo15154id = 2) long j, @Param(mo15154id = 3) long j2, @Param(mo15154id = 4) int i, @Param(mo15154id = 5) Bundle bundle) {
        boolean z = true;
