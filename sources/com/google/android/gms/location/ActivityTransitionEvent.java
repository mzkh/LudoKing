...
public class ActivityTransitionEvent extends AbstractSafeParcelable {
    ...
    @Field(getter = "getElapsedRealTimeNanos", mo15151id = 3)
    private final long zzk;

    @Constructor
    public ActivityTransitionEvent(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) int i2, @Param(mo15154id = 3) long j) {
