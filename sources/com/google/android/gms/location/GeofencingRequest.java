...
public class GeofencingRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getParcelableGeofences", mo15151id = 1)
    private final List<zzbh> zzap;
    @Field(getter = "getInitialTrigger", mo15151id = 2)
    ...
    @Constructor
    GeofencingRequest(@Param(mo15154id = 1) List<zzbh> list, @Param(mo15154id = 2) int i, @Param(mo15154id = 3) String str) {
        this.zzap = list;
        this.zzaq = i;
        this.tag = str;
    }
