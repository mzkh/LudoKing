...
public final class LocationSettingsResult extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getLocationSettingsStates", mo15151id = 2)
    ...
    @Constructor
    public LocationSettingsResult(@Param(mo15154id = 1) Status status, @Param(mo15154id = 2) LocationSettingsStates locationSettingsStates) {
        this.zzbl = status;
