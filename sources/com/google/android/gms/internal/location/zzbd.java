...
public final class zzbd extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo15151id = 10)
    @Nullable
    private String moduleId;
    @Field(defaultValueUnchecked = "null", mo15151id = 6)
    @Nullable
    private String tag;
    @Field(defaultValueUnchecked = "null", mo15151id = 1)
    private LocationRequest zzdg;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_HIDE_FROM_APP_OPS", mo15151id = 7)
    private boolean zzdh;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_FORCE_COARSE_LOCATION", mo15151id = 8)
    private boolean zzdi;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_EXEMPT_FROM_THROTTLE", mo15151id = 9)
    private boolean zzdj;
    private boolean zzdk = true;
    @Field(defaultValueUnchecked = "LocationRequestInternal.DEFAULT_CLIENTS", mo15151id = 5)
    private List<ClientIdentity> zzm;

    @Constructor
    zzbd(@Param(mo15154id = 1) LocationRequest locationRequest, @Param(mo15154id = 5) List<ClientIdentity> list, @Param(mo15154id = 6) @Nullable String str, @Param(mo15154id = 7) boolean z, @Param(mo15154id = 8) boolean z2, @Param(mo15154id = 9) boolean z3, @Param(mo15154id = 10) String str2) {
