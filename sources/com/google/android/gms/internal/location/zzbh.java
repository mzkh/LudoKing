...
public final class zzbh extends AbstractSafeParcelable implements Geofence {
    ...
    @Field(getter = "getRequestId", mo15151id = 1)
    private final String zzad;
    @Field(getter = "getTransitionTypes", mo15151id = 7)
    private final int zzae;
    @Field(getter = "getType", mo15151id = 3)
    private final short zzag;
    @Field(getter = "getLatitude", mo15151id = 4)
    private final double zzah;
    @Field(getter = "getLongitude", mo15151id = 5)
    private final double zzai;
    @Field(getter = "getRadius", mo15151id = 6)
    private final float zzaj;
    @Field(defaultValue = "0", getter = "getNotificationResponsiveness", mo15151id = 8)
    private final int zzak;
    @Field(defaultValue = "-1", getter = "getLoiteringDelay", mo15151id = 9)
    private final int zzal;
    @Field(getter = "getExpirationTime", mo15151id = 2)
    private final long zzdo;

    @Constructor
    public zzbh(@Param(mo15154id = 1) String str, @Param(mo15154id = 7) int i, @Param(mo15154id = 3) short s, @Param(mo15154id = 4) double d, @Param(mo15154id = 5) double d2, @Param(mo15154id = 6) float f, @Param(mo15154id = 2) long j, @Param(mo15154id = 8) int i2, @Param(mo15154id = 9) int i3) {
