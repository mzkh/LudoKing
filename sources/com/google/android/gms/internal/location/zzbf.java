...
public final class zzbf extends AbstractSafeParcelable {
    ...
    @Field(defaultValueUnchecked = "null", mo15151id = 4)
    private PendingIntent zzbv;
    @Field(defaultValueUnchecked = "LocationRequestUpdateData.OPERATION_ADD", mo15151id = 1)
    private int zzcg;
    @Field(defaultValueUnchecked = "null", getter = "getFusedLocationProviderCallbackBinder", mo15151id = 6, type = "android.os.IBinder")
    private zzaj zzcj;
    @Field(defaultValueUnchecked = "null", mo15151id = 2)
    private zzbd zzdl;
    @Field(defaultValueUnchecked = "null", getter = "getLocationListenerBinder", mo15151id = 3, type = "android.os.IBinder")
    private zzx zzdm;
    @Field(defaultValueUnchecked = "null", getter = "getLocationCallbackBinder", mo15151id = 5, type = "android.os.IBinder")
    private zzu zzdn;

    @Constructor
    zzbf(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) zzbd zzbd, @Param(mo15154id = 3) IBinder iBinder, @Param(mo15154id = 4) PendingIntent pendingIntent, @Param(mo15154id = 5) IBinder iBinder2, @Param(mo15154id = 6) IBinder iBinder3) {
        this.zzcg = i;
        this.zzdl = zzbd;
        zzaj zzaj = null;
