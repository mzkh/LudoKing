...
public abstract class zzee extends zzdm {
        ...
        public final void zzbn(long j) throws IOException {
            if (!zzee.zzaec || zztg() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    zzhv.zza(bArr3, (long) i3, (byte) ((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
        ...
        public final void zzbf(int i) throws IOException {
            if (this.zzaen <= this.zzaem) {
                while ((i & -128) != 0) {
                    long j = this.zzaen;
                    this.zzaen = j + 1;
                    zzhv.zza(j, (byte) ((i & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                    i >>>= 7;
                }
                long j2 = this.zzaen;
                this.zzaen = 1 + j2;
            ...
            while (true) {
                ...
                if (j3 >= this.zzael) {
                    ...
                    this.zzaen = j3 + 1;
                    zzhv.zza(j3, (byte) ((i & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                    i >>>= 7;
                }
            }
        }
        ...
        public final void zzbn(long j) throws IOException {
            if (this.zzaen <= this.zzaem) {
                while ((j & -128) != 0) {
                    long j2 = this.zzaen;
                    this.zzaen = j2 + 1;
                    zzhv.zza(j2, (byte) ((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                    j >>>= 7;
                }
                long j3 = this.zzaen;
                this.zzaen = 1 + j3;
            ...
            while (true) {
                ...
                if (j4 >= this.zzael) {
                    ...
                    this.zzaen = j4 + 1;
                    zzhv.zza(j4, (byte) ((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                    j >>>= 7;
                }
            }
        }
    ...
    static final class zze extends zzee {
        ...
        public final void zzbf(int i) throws IOException {
            while ((i & -128) != 0) {
                this.zzaei.put((byte) ((i & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                i >>>= 7;
            }
            try {
        ...
        public final void zzbn(long j) throws IOException {
            while ((-128 & j) != 0) {
                this.zzaei.put((byte) ((((int) j) & Notifications.NOTIFICATION_TYPES_ALL) | 128));
                j >>>= 7;
            }
            try {
