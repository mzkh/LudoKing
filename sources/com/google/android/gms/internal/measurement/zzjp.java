...
public final class zzjp implements zzjq {
    ...
    static {
        ...
        zzapx = zzct.zze("measurement.ad_id_cache_time", TapjoyConstants.TIMER_INCREMENT);
        ...
        zzaqk = zzct.zze("measurement.upload.realtime_upload_interval", TapjoyConstants.TIMER_INCREMENT);
        ...
        zzare = zzct.zze("measurement.upload.retry_time", TapjoyConstants.SESSION_ID_INACTIVITY_TIME);
