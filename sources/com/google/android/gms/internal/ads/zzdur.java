...
public final class zzdur {
    public static <T extends zzdus> String zza(T t) {
    ...
    private static void zza(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, InvocationTargetException {
        ...
        int i;
        if (obj != null) {
            if (obj instanceof zzdus) {
                int length = stringBuffer.length();
                if (str != null) {
                    stringBuffer2.append(stringBuffer);
                    stringBuffer2.append(zzhm(str));
            ...
            String zzhm = zzhm(str);
            stringBuffer2.append(stringBuffer);
            stringBuffer2.append(zzhm);
            stringBuffer2.append(": ");
    ...
    private static String zzhm(String str) {
        StringBuffer stringBuffer = new StringBuffer();
