...
public final class zzawg {
    ...
    public static String zza(zzawh zzawh) {
        return zzk(zzawh);
    }
    ...
    private static String zzk(Object obj) {
        ...
        try {
            ...
            zzaug.zzc("Error when writing JSON.", e);
            return null;
        }
    }
        ...
        try {
            ...
            while (keys.hasNext()) {
                ...
                if (obj instanceof String) {
                    ...
                    zza(jsonWriter.name(str), (JSONObject) obj);
                } else if (obj instanceof JSONArray) {
                    zza(jsonWriter.name(str), (JSONArray) obj);
                } else {
