...
public final class zzar extends zzah {
    ...
    private zzar(zzat zzat) {
        this(null, null);
    }

    private zzar(zzat zzat, SSLSocketFactory sSLSocketFactory) {
        this.zzcj = null;
        this.zzck = null;
    }
    ...
    public final com.google.android.gms.internal.ads.zzap zza(com.google.android.gms.internal.ads.zzq<?> r7, java.util.Map<java.lang.String, java.lang.String> r8) throws java.io.IOException, com.google.android.gms.internal.ads.zzb {
        /*
            r6 = this;
            ...
            r1.putAll(r8)
            com.google.android.gms.internal.ads.zzat r8 = r6.zzcj
        ...
        L_0x00ea:
            ...
            com.google.android.gms.internal.ads.zzap r7 = new com.google.android.gms.internal.ads.zzap     // Catch:{ all -> 0x0125 }
            ...
            return r7
        L_0x00fd:
            com.google.android.gms.internal.ads.zzap r7 = new com.google.android.gms.internal.ads.zzap     // Catch:{ all -> 0x0114 }
            ...
            com.google.android.gms.internal.ads.zzau r4 = new com.google.android.gms.internal.ads.zzau     // Catch:{ all -> 0x0114 }
    ...
    private static List<zzk> zza(Map<String, List<String>> map) {
        ...
        for (Entry entry : map.entrySet()) {
            if (entry.getKey() != null) {
                for (String zzk : (List) entry.getValue()) {
                    arrayList.add(new zzk((String) entry.getKey(), zzk));
                }
            }
        }
        return arrayList;
    ...
    private static void zza(HttpURLConnection httpURLConnection, zzq<?> zzq) throws IOException, zzb {
        ...
        if (zzf != null) {
            ...
            if (!httpURLConnection.getRequestProperties().containsKey(str)) {
                ...
                String str3 = "UTF-8";
                httpURLConnection.setRequestProperty(str, str3.length() != 0 ? str2.concat(str3) : new String(str2));
            }
