...
final class zzbfi extends zzbie {
    ...
    private zzbfi(zzbfa zzbfa, zzbli zzbli, zzcws zzcws, zzbmf zzbmf, zzcbx zzcbx, zzbpn zzbpn, zzbmk zzbmk, zzcxa zzcxa, zzcvz zzcvz, zzcuf zzcuf) {
        zzbli zzbli2 = zzbli;
        zzcbx zzcbx2 = zzcbx;
        zzbpn zzbpn2 = zzbpn;
        zzbmk zzbmk2 = zzbmk;
        ...
        this.zzemd = zzdwc.zzan(zzcah.zzf(this.zzerq.zzeki, this.zzemb, this.zzerq.zzekj, zzbig.zzaes(), this.zzemc));
        ...
        this.zzeoj = zzcrf.zza(zzcxk.zzanm(), this.zzerq.zzeke, zzbij.zzaex(), this.zzerq.zzekl, this.zzeki, this.zzelx, this.zzeol);
        ...
        zzcgk zzcgk = new zzcgk(this.zzevs, this.zzeki, this.zzerq.zzekc, this.zzepx, this.zzelx);
        this.zzevt = zzcgk;
        this.zzevu = ((zzdwf) zzdwd.zzho(1).zza("FirstPartyRendererAppOpen", this.zzevt)).zzbdf();
        this.zzevv = zzdwc.zzan(zzbkr.zzd(this.zzevu));
    ...
    public final zzbia zza(zzbla zzbla, zzbid zzbid) {
        zzdwh.checkNotNull(zzbla);
        zzdwh.checkNotNull(zzbid);
        return new zzbfh(this, zzbla, zzbid);
    }

    /* synthetic */ zzbfi(zzbfa zzbfa, zzbli zzbli, zzcws zzcws, zzbmf zzbmf, zzcbx zzcbx, zzbpn zzbpn, zzbmk zzbmk, zzcxa zzcxa, zzcvz zzcvz, zzcuf zzcuf, zzbez zzbez) {
