...
public final class zzbhs implements zzdwb<Set<zzbqs<zzbnm>>> {
    private final zzdwo<Executor> zzfck;
    private final zzdwo<zzbhk> zzfcs;
    private final zzdwo<JSONObject> zzfct;

    private zzbhs(zzdwo<zzbhk> zzdwo, zzdwo<Executor> zzdwo2, zzdwo<JSONObject> zzdwo3) {
        this.zzfcs = zzdwo;
        this.zzfck = zzdwo2;
        this.zzfct = zzdwo3;
    }

    public static zzbhs zzd(zzdwo<zzbhk> zzdwo, zzdwo<Executor> zzdwo2, zzdwo<JSONObject> zzdwo3) {
        return new zzbhs(zzdwo, zzdwo2, zzdwo3);
    }
