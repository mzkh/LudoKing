...
public final class zaa extends AbstractSafeParcelable implements Result {
    ...
    @Field(getter = "getConnectionResultCode", mo15151id = 2)
    private int zarz;
    @Field(getter = "getRawAuthResolutionIntent", mo15151id = 3)
    private Intent zasa;

    @Constructor
    zaa(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) int i2, @Param(mo15154id = 3) Intent intent) {
        this.zalf = i;
        this.zarz = i2;
        this.zasa = intent;
    }
