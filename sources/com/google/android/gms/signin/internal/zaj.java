...
public final class zaj extends AbstractSafeParcelable {
    ...
    @Field(getter = "getConnectionResult", mo15151id = 2)
    private final ConnectionResult zadi;
    @VersionField(mo15157id = 1)
    private final int zalf;
    @Field(getter = "getResolveAccountResponse", mo15151id = 3)
    private final ResolveAccountResponse zase;

    @Constructor
    zaj(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) ConnectionResult connectionResult, @Param(mo15154id = 3) ResolveAccountResponse resolveAccountResponse) {
        this.zalf = i;
