...
public class TokenData extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getGrantedScopes", mo15151id = 6)
    private final List<String> zzaa;
    @Field(getter = "getScopeData", mo15151id = 7)
    private final String zzab;
    @VersionField(mo15157id = 1)
    private final int zzv;
    @Field(getter = "getToken", mo15151id = 2)
    private final String zzw;
    @Field(getter = "getExpirationTimeSecs", mo15151id = 3)
    private final Long zzx;
    @Field(getter = "isCached", mo15151id = 4)
    private final boolean zzy;
    @Field(getter = "isSnowballed", mo15151id = 5)
    ...
    @Constructor
    TokenData(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) String str, @Param(mo15154id = 3) Long l, @Param(mo15154id = 4) boolean z, @Param(mo15154id = 5) boolean z2, @Param(mo15154id = 6) List<String> list, @Param(mo15154id = 7) String str2) {
        this.zzv = i;
