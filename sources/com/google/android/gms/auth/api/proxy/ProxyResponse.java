...
public class ProxyResponse extends AbstractSafeParcelable {
    ...
    @Constructor
    ProxyResponse(@Param(mo15154id = 1000) int i, @Param(mo15154id = 1) int i2, @Param(mo15154id = 2) PendingIntent pendingIntent, @Param(mo15154id = 3) int i3, @Param(mo15154id = 4) Bundle bundle, @Param(mo15154id = 5) byte[] bArr) {
        this.versionCode = i;
