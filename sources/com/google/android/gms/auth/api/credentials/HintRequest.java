...
public final class HintRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "getAccountTypes", mo15151id = 4)
    ...
    @Field(getter = "getHintPickerConfig", mo15151id = 1)
    private final CredentialPickerConfig zzah;
    @Field(getter = "isEmailAddressIdentifierSupported", mo15151id = 2)
    private final boolean zzai;
    @Field(getter = "isPhoneNumberIdentifierSupported", mo15151id = 3)
    ...
    @Constructor
    HintRequest(@Param(mo15154id = 1000) int i, @Param(mo15154id = 1) CredentialPickerConfig credentialPickerConfig, @Param(mo15154id = 2) boolean z, @Param(mo15154id = 3) boolean z2, @Param(mo15154id = 4) String[] strArr, @Param(mo15154id = 5) boolean z3, @Param(mo15154id = 6) String str, @Param(mo15154id = 7) String str2) {
        this.zzu = i;
        this.zzah = (CredentialPickerConfig) Preconditions.checkNotNull(credentialPickerConfig);
        this.zzai = z;
        this.zzaj = z2;
