...
public final class CredentialRequest extends AbstractSafeParcelable {
    ...
    @Field(getter = "getAccountTypes", mo15151id = 2)
    private final String[] zzaa;
    @Field(getter = "getCredentialPickerConfig", mo15151id = 3)
    private final CredentialPickerConfig zzab;
    @Field(getter = "getCredentialHintPickerConfig", mo15151id = 4)
    private final CredentialPickerConfig zzac;
    @Field(getter = "isIdTokenRequested", mo15151id = 5)
    private final boolean zzad;
    @Field(getter = "getServerClientId", mo15151id = 6)
    private final String zzae;
    @Field(getter = "getIdTokenNonce", mo15151id = 7)
    private final String zzaf;
    @Field(getter = "getRequireUserMediation", mo15151id = 8)
    private final boolean zzag;
    @Field(mo15151id = 1000)
    private final int zzu;
    @Field(getter = "isPasswordLoginSupported", mo15151id = 1)
    ...
    @Constructor
    CredentialRequest(@Param(mo15154id = 1000) int i, @Param(mo15154id = 1) boolean z, @Param(mo15154id = 2) String[] strArr, @Param(mo15154id = 3) CredentialPickerConfig credentialPickerConfig, @Param(mo15154id = 4) CredentialPickerConfig credentialPickerConfig2, @Param(mo15154id = 5) boolean z2, @Param(mo15154id = 6) String str, @Param(mo15154id = 7) String str2, @Param(mo15154id = 8) boolean z3) {
        this.zzu = i;
        this.zzz = z;
