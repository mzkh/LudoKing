...
public final class CredentialPickerConfig extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(getter = "shouldShowCancelButton", mo15151id = 2)
    private final boolean mShowCancelButton;
    @Field(mo15151id = 1000)
    private final int zzu;
    @Field(getter = "shouldShowAddAccountButton", mo15151id = 1)
    private final boolean zzv;
    @Field(getter = "isForNewAccount", mo15151id = 3)
    @Deprecated
    private final boolean zzw;
    @Field(getter = "getPromptInternalId", mo15151id = 4)
    ...
    CredentialPickerConfig(@com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo15154id = 1000) int r2, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo15154id = 1) boolean r3, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo15154id = 2) boolean r4, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo15154id = 3) boolean r5, @com.google.android.gms.common.internal.safeparcel.SafeParcelable.Param(mo15154id = 4) int r6) {
        /*
            r1 = this;
            r1.<init>()
            r1.zzu = r2
