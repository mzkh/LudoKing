...
public class SignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @Field(defaultValue = "", mo15151id = 4)
    @Deprecated
    private String zzba;
    @Field(getter = "getGoogleSignInAccount", mo15151id = 7)
    private GoogleSignInAccount zzbb;
    @Field(defaultValue = "", mo15151id = 8)
    @Deprecated
    private String zzbc;

    @Constructor
    SignInAccount(@Param(mo15154id = 4) String str, @Param(mo15154id = 7) GoogleSignInAccount googleSignInAccount, @Param(mo15154id = 8) String str2) {
