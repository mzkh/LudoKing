...
public class GoogleSignInOptions extends AbstractSafeParcelable implements Optional, ReflectedParcelable {
    ...
    @Field(getter = "isForceCodeForRefreshToken", mo15151id = 6)
    public final boolean zaaa;
    /* access modifiers changed from: private */
    @Field(getter = "getServerClientId", mo15151id = 7)
    public String zaab;
    /* access modifiers changed from: private */
    @Field(getter = "getHostedDomain", mo15151id = 8)
    public String zaac;
    /* access modifiers changed from: private */
    @Field(getter = "getExtensions", mo15151id = 9)
    ...
    /* access modifiers changed from: private */
    @Field(getter = "getScopes", mo15151id = 2)
    public final ArrayList<Scope> zaw;
    /* access modifiers changed from: private */
    @Field(getter = "getAccount", mo15151id = 3)
    public Account zax;
    /* access modifiers changed from: private */
    @Field(getter = "isIdTokenRequested", mo15151id = 4)
    public boolean zay;
    /* access modifiers changed from: private */
    @Field(getter = "isServerAuthCodeRequested", mo15151id = 5)
    ...
    @Constructor
    GoogleSignInOptions(@Param(mo15154id = 1) int i, @Param(mo15154id = 2) ArrayList<Scope> arrayList, @Param(mo15154id = 3) Account account, @Param(mo15154id = 4) boolean z, @Param(mo15154id = 5) boolean z2, @Param(mo15154id = 6) boolean z3, @Param(mo15154id = 7) String str, @Param(mo15154id = 8) String str2, @Param(mo15154id = 9) ArrayList<GoogleSignInOptionsExtensionParcelable> arrayList2) {
