...
/* renamed from: com.adcolony.sdk.ax */
class C0575ax {
    ...
    /* renamed from: com.adcolony.sdk.ax$a */
    private static class C0576a {
        private C0576a() {
        }

        /* renamed from: a */
        static int m480a(WindowManager windowManager) {
    ...
    /* renamed from: com.adcolony.sdk.ax$b */
    private static class C0577b {
        private C0577b() {
        }

        /* renamed from: a */
        static int m481a(WindowManager windowManager) {
            Point point = new Point();
            windowManager.getDefaultDisplay().getSize(point);
            return point.x;
        }
    ...
    static float m472a(android.view.View r9, android.content.Context r10, boolean r11, boolean r12, boolean r13, boolean r14) {
        /*
            r0 = 0
        ...
        L_0x0092:
            ...
            float r9 = m473a(r9, r3, r10, r1)     // Catch:{ Exception -> 0x00b2 }
        ...
        L_0x0114:
            ...
            float r9 = m473a(r9, r4, r10, r2)     // Catch:{ Exception -> 0x0130 }
        ...
        L_0x013f:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C0575ax.m472a(android.view.View, android.content.Context, boolean, boolean, boolean, boolean):float");
    }
    ...
    /* renamed from: a */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static float m473a(android.view.View r11, android.graphics.Rect r12, float r13, boolean r14) {
        /*
        ...
        L_0x00a9:
            ...
            goto L_0x00a9
        L_0x00cd:
            java.util.ArrayList r6 = m478b(r6)
        ...
        L_0x0173:
            ...
            android.graphics.Rect r8 = m476a(r1, r12, r3)
            int r9 = r8.height()
        ...
        L_0x01b9:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.adcolony.sdk.C0575ax.m473a(android.view.View, android.graphics.Rect, float, boolean):float");
    }

    /* renamed from: a */
    private static Rect m476a(Rect rect, Rect rect2, int i) {
        Rect rect3 = new Rect();
        switch (i) {
            case 1:
    ...
    /* renamed from: a */
    private static float m471a(View view) {
        if (view == null) {
            return 0.0f;
        }
        if (m474a() < 11) {
    ...
    /* renamed from: b */
    private static ArrayList<View> m478b(View view) {
        if ((view instanceof ViewGroup) && view.getVisibility() == 0 && m471a(view) != 0.0f) {
            ...
            while (listIterator.hasNext()) {
                ...
                for (int i = 0; i < childCount; i++) {
                    ...
                    if (childAt.getVisibility() == 0 && m471a(childAt) != 0.0f) {
    ...
    /* renamed from: c */
    private static boolean m479c(View view) {
        boolean z = false;
        if (view == null) {
            return false;
        }
        if (view.getBackground() == null || (m474a() > 18 && view.getBackground().getAlpha() == 0)) {
            z = true;
        }
        return z;
    }
    ...
    /* renamed from: a */
    private static int m475a(Context context) {
        int i;
    ...
    /* renamed from: b */
    private static int m477b(Context context) {
        int i;
        int i2 = context != null ? context.getResources().getConfiguration().orientation : -1;
        if (i2 == 2) {
            int i3 = f527b;
