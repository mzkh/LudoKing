        ...
        if (webPlayer != null) {
            Utilities.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    WebPlayerEventBridge.sendGetFrameResponse(str, str2, iArr[0], iArr[1], webPlayer.getWidth(), webPlayer.getHeight(), VERSION.SDK_INT >= 11 ? webPlayer.getAlpha() : 1.0f);
                }
            });
        }
    }
